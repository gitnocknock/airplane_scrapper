...
<div className="grid grid-cols-3 gap-0 h-screen">
  <div className="bg-gray-800 w-full h-full border-r border-gray-700">
   ...
   <button className="bg-cyan-400 hover:bg-cyan-500 w-32 h-12 rounded-lg font-bold text-white text-lg flex items-center justify-center transition-colors duration-300 hover:cursor-pointer">
  Deploy New
  </button>
...
<div className="bg-gray-900 w-full h-full">
  <div className="grid grid-rows-2 gap-5 place-items-center pt-5">
    <div className="bg-cyan-950/50 h-screen w-70 rounded-lg border border-gray-700">
...
<div className="bg-gray-800 w-full h-full border-l border-gray-700">
  <div className="p-6">
    ...
    <div className="grid grid-rows-3 gap-4 place-items-center">
      <div className="bg-gray-700 w-48 h-32 rounded-lg border border-blue-500/30 text-blue-400 font-bold p-4 flex items-center justify-center">
        Ayusma
      </div>
      
      <div className="bg-gray-700 w-48 h-32 rounded-lg border border-cyan-500/30 text-cyan-400 font-bold p-4 flex items-center justify-center">
        Chakre
      </div>
      
      <div className="bg-gray-700 w-48 h-32 rounded-lg border border-purple-500/30 text-purple-400 font-bold p-4 flex items-center justify-center">
        I LOVE YOU
      </div>
    </div>
  </div>
